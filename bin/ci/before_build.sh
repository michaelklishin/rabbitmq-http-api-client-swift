...
CTL=${SWIFT_HTTP_API_CLIENT_RABBITMQCTL:="sudo rabbitmqctl"}
PLUGINS=${SWIFT_HTTP_API_CLIENT_RABBITMQ_PLUGINS:="sudo rabbitmq-plugins"}
...
$CTL add_vhost "swift/http/api/client"
$CTL set_permissions -p "swift/http/api/client" guest ".*" ".*" ".*"
